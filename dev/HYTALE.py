...
HYTALE_ASSETS_PATH = r"E:\Hytale Assets 20260328" # path to a folder in which you have put the contents of Assets.zip after decompressing.
assert os.path.isdir(HYTALE_ASSETS_PATH), "please extract hytale assets and configure the path to the extracted assets within HYTALE.py"
